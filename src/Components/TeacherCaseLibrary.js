...
function TeacherCaseLibrary() {
  ...
  // Debugging: Log casesData on component load
  // console.log('casesData:', casesData);

  // Fetch students dynamically from the backend

  // useEffect(() => {
  //   const socket = new WebSocket('ws://localhost:5000'); // Replace with the actual WebSocket server URL
